...
dojo.provide("bespin.deploy");

bespin.deploy.commands = new bespin.command.Store(bespin.command.store, {
    name: 'deploy',
        ...
        bespin.vcs.getInfoFromUser(instruction, function(values) {
            ...
            server.getDeploySetup(project, {kcpass:kcpass}, {
                onSuccess: function(currentSetup) {
                    ...
                    td = dojo.create("td", {}, tr);
                    dojo.create("input", {name: "remoteHost",
                        value: currentSetup.remoteHost || ""}, td);

                    // Remote directory
                    tr = dojo.create("tr", {}, table);
                    td = dojo.create("td", {innerHTML: "Remote directory:"}, tr);
                    td = dojo.create("td", {}, tr);
                    dojo.create("input", {name: "remoteDirectory",
                        value: currentSetup.remoteDirectory || ""}, td);
                    ...
                    if (!bespin.vcs._keychainpw) {
                        ...
                        dojo.create("input", {type:"hidden", name: "kcpass", 
                            value: bespin.vcs._keychainpw}, td);
                    }
                    ...
                    bespin.deploy._createOption(select, 
                        "password", "Password",currentSetup.authType);

                    // Username
                    tr = dojo.create("tr", {}, table);
                    td = dojo.create("td", {innerHTML: "Username:"}, tr);
                    td = dojo.create("td", {}, tr);
                    dojo.create("input", {type: "text", name: "username",
